...
static const config_t config_instance = {
    ...
    .torque_map = {
        ...
        .output_max = 1000, // Warning: This is dynamically modified by .ctrl.{hard,endurance,crawl}_max_torque when entering R2D depending on the current mode
