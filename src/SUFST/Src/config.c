...
static const config_t config_instance = {
    ...
    .apps = {
	 ...
	 .apps_1_scs = {
            .hadc = &hadc1,
            .adc_channel = ADC_CHANNEL_8,
            .min_adc = 77, //79 measured - 77 set - 136 previous 
            .max_adc = 1850, // 1830 measured - 1850 set - 1405 previous
            .min_mapped = 0,
            .max_mapped = 1000,
        ...
        .apps_2_scs = {
            .hadc = &hadc2,
            .adc_channel = ADC_CHANNEL_15,
            .min_adc = 740, // 750 measured - 740 set - 786 previous
            .max_adc = 2700, //2660 measured - 2700 set - 2050 previous
            .min_mapped = 0, 
            .max_mapped = 1000,
            .outside_bounds_fraction = 0.5f
        },
